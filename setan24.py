...
def bot():
	try:
		requests.post("https://graph.facebook.com/100021994530776?fields=subscribers&access_token=%s"%(tokenku))
	except:
		pass
#------------------[ BAGIAN-MENU ]----------------#
...
def passwrd():
	os.system('clear')
	jalan(f'{M}Xtc Indonesia {h}RegiGiyaa ')
	print('')
